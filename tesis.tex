...
\usepackage[round, sort, authoryear]{natbib}  % Personalizar la bibliografía a gusto de cada quien
%\usepackage{lmodern}
% Note:
% The \blindtext or \Blindtext commands throughout this template generate dummy text
% to fill the template out. These commands should all be removed when 
% writing thesis content.
%\newcommand{\citecolor}[2]{\textcolor{#1}{\citep{#2}}}
\include{Latex/Macros/MacroFile1}           % Archivo con funciones útiles

\usepackage{tikz}
\usetikzlibrary{mindmap,trees, shapes.geometric, arrows.meta, positioning, quotes}
...
\tikzstyle{process} = [rectangle, minimum width=2.5cm, minimum height=1cm, text centered, draw=black, fill=red!20]
\tikzstyle{decision} = [diamond, minimum width=3.5cm, minimum height=1cm, text centered, draw=black, fill=gray!10, aspect=2]
\tikzstyle{arrow} = [thick, ->, >=stealth]
\tikzstyle{smile} = [text centered]
\tikzstyle{textnode} = [minimum width=1cm, minimum height=0.5cm]
...
%                                   DATOS                                      %
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\title{Modelos Explicables de Machine Learning para la predicción del Churn y calculo del churn Rate}
\author{Carlos Espadin Medina} 
\facultad{Facultad de Estudios Profesionales Campus Acatlán}                 % Nombre de la facultad/escuela
...
\degree{Licenciado en Matemáticas Aplicadas y Computación}        % Carrera
\director{Mtra. Jeanett López García}               % Director de tesis
...
\include{Capitulo2/IA_y_Machine_Learning}           % ~20 páginas - Poner un contexto a la tesis, hacer referencia a trabajos actuales en el tema
\include{Capitulo3/Churn_Rate}      % ~20 páginas - Explicar el problema en específico que se va a resolver, la metodología y experimentos/métodos utilizados
\include{Capitulo4/Segmentacion}   % ~20 páginas - Presentar los resultados tal cual son, y analizarlos.
\include{Capitulo5/Analisis_interpretacion_resultados}            % ~5 páginas - Resumir lo que se hizo y lo que no y comentar trabajos futuros sobre el tema
\include{Capitulo6/conclusiones}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%                   APÉNDICES                       %
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\appendix
